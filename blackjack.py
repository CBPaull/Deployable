    ...
    def run_game(self):
        ...
        while(playing):
            ...
            for person in players_in_game:
                print("You have %s in your hand, Your current count is %d") % (person.show_hand(), self.check_hand(person))
                print("the dealer shows %s") % Dealer.reveal()
                split = ""
                if person.can_split():
